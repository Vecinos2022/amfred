          ...
          <div className='grid grid-cols-1 gap-8 lg:grid-cols-2 lg:gap-16'>
            ...
            <div className='lg:py-24'>
              ...
              <p className='mt-4 text-gray-600'>
                ...
                normas y reglamentos de seguridad, protección civil y juzgados
                cívicas correspondientes para generar las condiciones de armonía
                y bien común que los colonos de diferentes fraccionamientos,
                edificios departamentales o cualquier junta vecinal requiere
                para formar ciudadanos comprometidos.
              </p>
            </div>
          </div>
        </div>
...
export default NosotrosMisionVision
;('')
